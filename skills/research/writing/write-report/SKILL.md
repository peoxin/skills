...
Read Reference records and analyses, Dataset derivations, Benchmark/Experiment specs, declared Experiment outputs, and user-confirmed claims. Keep canonical metrics and provenance in the records declared by the Experiment; the draft is a presentation layer and must not rewrite experiment records.
